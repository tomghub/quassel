...
class MySqlStorage : public AbstractSqlStorage {
  Q_OBJECT
...
protected:
  ...
  inline virtual QString driverName() { return "QMYSQL"; }
...
inline void MySqlStorage::safeExec(QSqlQuery &query) { query.exec(); }


// ========================================
//  MySqlMigration
// ========================================
class MySqlMigrationWriter : public MySqlStorage, public AbstractSqlMigrationWriter {
  Q_OBJECT
